...
class Data_EweiShopV2Page extends ComWebPage {
    ...
    function main() {
        ...
        $items = pdo_fetchall('SELECT d.*,o.carrier,m.avatar,m.nickname,o.status FROM ' . tablename('ewei_shop_virtual_data') . " d "
            . " left join " . tablename('ewei_shop_member') . ' m on m.openid = d.openid and m.uniacid= d.uniacid and d.merchid=0'
            . " left join " . tablename('ewei_shop_order') . ' o on o.id = d.orderid '
            . " where  1 {$condition} order by {$order} limit " . ($pindex - 1) * $psize . ',' . $psize, $params);
        ...
        unset($row);
        $total = pdo_fetchcolumn("SELECT COUNT(*) FROM " . tablename('ewei_shop_virtual_data') . " d "
            . " left join " . tablename('ewei_shop_member') . ' m on m.openid = d.openid and m.uniacid=d.uniacid and d.merchid=0'
            . " left join " . tablename('ewei_shop_order') . ' o on o.id = d.orderid '
    ...
    function export() {
        ...
        $list = pdo_fetchall('SELECT d.*,o.carrier,m.avatar,m.nickname FROM ' . tablename('ewei_shop_virtual_data') . " d "
            . " left join " . tablename('ewei_shop_member') . ' m on m.openid = d.openid and m.uniacid = d.uniacid and d.merchid=0'
            . " left join " . tablename('ewei_shop_order') . ' o on o.id = d.orderid '
            . " where  1 {$condition} order by usetime desc", $params);
