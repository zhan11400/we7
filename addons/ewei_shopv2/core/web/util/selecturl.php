...
class Selecturl_EweiShopV2Page extends WebPage 
{
	...
	public function main() 
	{
		...
		if( $platform ) 
		{
			...
			if( $platform != "wxapp_tabbar" && $platform != "" && cv("dividend") && p("dividend") ) 
			{
		...
		$allUrls[0]["list"][] = array( "name" => "多商户店铺", "url" => mobileUrl("", NULL, $full), "url_wxapp" => "/pages/changce/merch/index" );
		$allUrls[0]["list"][] = array( "name" => "多商户入住", "url" => mobileUrl("", NULL, $full), "url_wxapp" => "/pages/changce/merch/apply" );		
		$allUrls[0]["list"][] = array( "name" => "积分签到", "url" => mobileUrl("", NULL, $full), "url_wxapp" => "/pages/web/index?iswxapp=true&module=sign&domain=https://" . $_SERVER['HTTP_HOST'] . "/app/index.php&params=i%3D2%26c%3Dentry%26m%3Dewei_shopv2%26do%3Dmobile%26r%3Dsign&mid=" );		
		...
		if( $platform ) 
		{
			...
			if( !empty($customs) ) 
			{
				$addUrl = array( "name" => "自定义页面", "list" => array( ) );
				$urllist = array( );
		...
		{
			$allUrls[] = array( "name" => m("plugin")->getName("commission"), "list" => array( array( "name" => "分销中心", "url" => mobileUrl("commission", NULL, $full), "url_wxapp" => "/pages/commission/index" ), array( "name" => "成为分销商", "url" => mobileUrl("commission/register", NULL, $full), "url_wxapp" => "" ), array( "name" => "我的小店", "url" => mobileUrl("commission/myshop", NULL, $full), "url_wxapp" => "" ), array( "name" => "分销佣金/佣金提现", "url" => mobileUrl("commission/withdraw", NULL, $full), "url_wxapp" => "" ), array( "name" => "分销订单", "url" => mobileUrl("commission/order", NULL, $full), "url_wxapp" => "" ), array( "name" => "我的下线", "url" => mobileUrl("commission/down", NULL, $full), "url_wxapp" => "" ), array( "name" => "提现明细", "url" => mobileUrl("commission/log", NULL, $full), "url_wxapp" => "" ), array( "name" => "推广二维码", "url" => mobileUrl("commission/qrcode", NULL, $full), "url_wxapp" => "" ), array( "name" => "小店设置", "url" => mobileUrl("commission/myshop/set", NULL, $full), "url_wxapp" => "" ), array( "name" => "佣金排名", "url" => mobileUrl("commission/rank", NULL, $full), "url_wxapp" => "" ), array( "name" => "自选商品", "url" => mobileUrl("commission/myshop/select", NULL, $full), "url_wxapp" => "" ) ) );
		}
		if( cv("offic.system.edit") && p("offic") && !$platform ) 
		{
			$allUrls[] = array( "name" => m("plugin")->getName("offic"), "list" => array( array( "name" => "选品", "url" => mobileUrl("offic", NULL, $full), "url_wxapp" => "" ), array( "name" => "发现", "url" => mobileUrl("offic/find", NULL, $full), "url_wxapp" => "" ), array( "name" => "我的分店", "url" => mobileUrl("commission/branch", NULL, $full), "url_wxapp" => "" ), array( "name" => "我的粉丝", "url" => mobileUrl("commission/branch/fans", NULL, $full), "url_wxapp" => "" ), array( "name" => "我的小店", "url" => mobileUrl("offic/myshop", NULL, $full), "url_wxapp" => "" ) ) );
		}
		if( cv("article.edit") && p("article") && !$platform ) 
		{
			$allUrls[] = array( "name" => m("plugin")->getName("article"), "list" => array( array( "name" => "文章列表页面", "url" => mobileUrl("article/list", NULL, $full), "url_wxapp" => "" ) ) );
		}
		$allUrls[] = array( "name" => m("plugin")->getComName("coupon"), "list" => array( array( "name" => "领取优惠券", "url" => mobileUrl("sale/coupon", NULL, $full), "url_wxapp" => "/pages/sale/coupon/index/index" ), array( "name" => "我的优惠券", "url" => mobileUrl("sale/coupon/my", NULL, $full), "url_wxapp" => "/pages/sale/coupon/my/index/index" ) ) );
		if( cv("groups.goods.edit") && p("groups") && !$platform ) 
		{
			$allUrls[] = array( "name" => m("plugin")->getName("groups"), "list" => array( array( "name" => "拼团首页", "url" => mobileUrl("groups", NULL, $full), "url_wxapp" => "" ), array( "name" => "活动列表", "url" => mobileUrl("groups/category", NULL, $full), "url_wxapp" => "" ), array( "name" => "我的订单", "url" => mobileUrl("groups/orders", NULL, $full), "url_wxapp" => "" ), array( "name" => "我的团", "url" => mobileUrl("groups/team", NULL, $full), "url_wxapp" => "" ) ) );
		}
		if( cv("mr.goods.edit") && p("mr") && !$platform ) 
		{
			$allUrls[] = array( "name" => m("plugin")->getName("mr"), "list" => array( array( "name" => "充值页面", "url" => mobileUrl("mr", NULL, $full), "url_wxapp" => "" ), array( "name" => "充值记录", "url" => mobileUrl("mr/order", NULL, $full), "url_wxapp" => "" ) ) );
		}
		if( cv("sns.adv.edit") && p("sns") && !$platform ) 
		{
			$allUrls[] = array( "name" => m("plugin")->getName("sns"), "list" => array( array( "name" => "社区首页", "url" => mobileUrl("sns", NULL, $full), "url_wxapp" => "" ), array( "name" => "全部板块", "url" => mobileUrl("sns/board/lists", NULL, $full), "url_wxapp" => "" ), array( "name" => "我的社区", "url" => mobileUrl("sns/user", NULL, $full), "url_wxapp" => "" ) ) );
		}
		if( cv("sign.rule.edit") && p("sign") && !$platform ) 
		{
			$allUrls[] = array( "name" => m("plugin")->getName("sign"), "list" => array( array( "name" => "签到首页", "url" => mobileUrl("sign", NULL, $full), "url_wxapp" => "" ), array( "name" => "签到排行", "url" => mobileUrl("sign/rank", NULL, $full), "url_wxapp" => "" ) ) );
		}
		if( cv("qa.adv.edit") && p("qa") && !$platform ) 
		{
			$allUrls[] = array( "name" => m("plugin")->getName("qa"), "list" => array( array( "name" => "帮助首页", "url" => mobileUrl("qa", NULL, $full), "url_wxapp" => "" ), array( "name" => "全部分类", "url" => mobileUrl("qa/category", NULL, $full), "url_wxapp" => "" ), array( "name" => "全部问题", "url" => mobileUrl("qa/question", NULL, $full), "url_wxapp" => "" ) ) );
		}
		if( cv("bargain.react") && p("bargain") && !$platform ) 
		{
			$allUrls[] = array( "name" => m("plugin")->getName("bargain"), "list" => array( array( "name" => "砍价首页", "url" => mobileUrl("bargain", NULL, $full), "url_wxapp" => "" ) ) );
		}
		if( cv("task.edit") && p("task") && !$platform ) 
		{
			$allUrls[] = array( "name" => m("plugin")->getName("task"), "list" => array( array( "name" => "首页", "url" => mobileUrl("task", NULL, $full), "url_wxapp" => "" ) ) );
		}
		if( cv("creditshop.goods.edit") && p("creditshop") && !$platform ) 
		{
			$allUrls[] = array( "name" => m("plugin")->getName("creditshop"), "list" => array( array( "name" => "商城首页", "url" => mobileUrl("creditshop", NULL, $full), "url_wxapp" => "" ), array( "name" => "全部商品", "url" => mobileUrl("creditshop/lists", NULL, $full), "url_wxapp" => "" ), array( "name" => "我的", "url" => mobileUrl("creditshop/log", NULL, $full), "url_wxapp" => "" ), array( "name" => "参与记录", "url" => mobileUrl("creditshop/creditlog", NULL, $full), "url_wxapp" => "" ) ) );
		}
		if( cv("seckill.task.edit") && p("seckill") && !$platform ) 
		{
			$allUrls[] = array( "name" => m("plugin")->getName("seckill"), "list" => array( array( "name" => "秒杀首页", "url" => mobileUrl("seckill", NULL, $full), "url_wxapp" => "" ) ) );
		}
		if( cv("newstore.temp.edit") && p("newstore") && !$platform ) 
		{
			$allUrls[] = array( "name" => m("plugin")->getName("newstore"), "list" => array( array( "name" => "门店列表", "url" => mobileUrl("newstore/stores", NULL, $full), "url_wxapp" => "" ) ) );
		}
		if( cv("globonus.partner.edit") && p("globonus") && !$platform ) 
		{
			$allUrls[] = array( "name" => m("plugin")->getName("globonus"), "list" => array( array( "name" => "股东首页", "url" => mobileUrl("globonus", NULL, $full), "url_wxapp" => "" ) ) );
		}
		if( $type == "levellink" ) 
		{
			unset($allUrls);
